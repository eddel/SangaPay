  ...
  return (
    <div className="flex min-h-dvh flex-col justify-between py-8">
      <div>
        ...
        <div className="mt-10 overflow-hidden rounded-[32px] border border-[var(--color-ring)] bg-white p-6">
          <div className="rounded-[28px] bg-slate-950 p-6 text-white">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="rounded-full border border-white/15 px-3 py-2 text-xs font-semibold text-white/80">
                {accentLabel}
              </div>
            </div>
      ...
      <div className="space-y-3 pb-2">
        {!isLastSlide ? (
          <button
            type="button"
            className="flex h-14 w-full items-center justify-center rounded-full bg-[var(--color-ink)] text-sm font-semibold text-white"
        ...
        {isLastSlide ? (
          <>
            <Link
              href="/signup"
              className="flex h-14 items-center justify-center rounded-full bg-slate-950 text-sm font-semibold text-white"
            >
              Create account
            </Link>
            <Link
