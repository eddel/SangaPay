...
export function RecentTransactionsPreview({
  ...
  return (
    <section
      ...
      className="mt-6 bg-transparent px-2 pb-4"
    >
          ...
          >
            <div className="flex items-start justify-between gap-4">
              <div className="flex min-w-0 items-start gap-3">
                ...
                <div>
                  <p className="whitespace-nowrap text-[0.95rem] font-semibold tracking-[-0.02em] text-slate-950">
                    {transaction.title}
                  </p>
              ...
              <div className="flex items-center gap-2 text-right">
                <div className="min-w-[108px]">
                  ...
                  <p className="mt-1 text-[13px] font-medium text-slate-500">{transaction.meta}</p>
                </div>
